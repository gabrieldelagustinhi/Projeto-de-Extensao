$(document).ready(function () {
    ...
    let cursosSection = $('#cursos-area');
    let inpirationSection = $('#inspiration-area');
    let disciplineSection = $('#discipline-area');
    ...
    $(navBtn).click(function(){
        ...
        } else if (btnId == 'cRealizados-menu'){
            scrollTo = cursosSection;
        } else if (btnId == 'inspiracao-menu'){
            scrollTo = inpirationSection;
        } else if (btnId == 'graduacao-menu'){
            scrollTo = disciplineSection;
